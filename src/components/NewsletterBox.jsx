  ...
  return (
    <div className='text-center'>
        ...
        <p className='mt-3 text-gray-400'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur, perspiciatis ut tenetur repellendus odio sit cumque exercitationem excepturi laudantium praesentium quod, impedit vel nisi dolorem commodi suscipit labore nihil modi.
        </p>
